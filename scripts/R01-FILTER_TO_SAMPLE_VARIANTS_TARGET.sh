...
START_FILTER_TO_SAMPLE_VARIANTS_TARGET=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" --analysis_type SelectVariants"
			...
			CMD=${CMD}" --variant ${CORE_PATH}/${OUTPUT_DIR}/${FAMILY}/${SM_TAG}/VCF/FILTERED_ON_TARGET/${SM_TAG}.ALL_SITES.TARGET.vcf.gz"
		CMD=${CMD}" --out ${CORE_PATH}/${OUTPUT_DIR}/${FAMILY}/${SM_TAG}/VCF/FILTERED_ON_TARGET/${SM_TAG}.VARIANT_SITES.TARGET.vcf"
...
END_FILTER_TO_SAMPLE_VARIANTS_TARGET=`date '+%s'`

# write out timing metrics to file

	echo ${SM_TAG}_${OUTPUT_DIR},R01,FILTER_TO_SAMPLE_VARIANTS_TARGET,${HOSTNAME},${START_FILTER_TO_SAMPLE_VARIANTS_TARGET},${END_FILTER_TO_SAMPLE_VARIANTS_TARGET} \
