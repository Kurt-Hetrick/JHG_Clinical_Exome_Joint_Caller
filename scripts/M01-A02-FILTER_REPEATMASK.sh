...
START_FILTER_COHORT_SNV_PASS_REPEATMASK=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" SelectVariants"
			...
			CMD=${CMD}" --variant ${CORE_PATH}/${OUTPUT_DIR}/TEMP/VCF_PREP/CONTROLS_PLUS_${FAMILY}.VQSR.ANNOTATED.SNV_ONLY.PASS.BIALLELIC.vcf"
		CMD=${CMD}" --output ${CORE_PATH}/${OUTPUT_DIR}/TEMP/VCF_PREP/CONTROLS_PLUS_${FAMILY}.VQSR.ANNOTATED.SNV_ONLY.PASS.BIALLELIC.REPEATMASK.vcf.gz"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${OUTPUT_DIR},N01,FILTER_COHORT_SNV_PASS_REPEATMASK,${HOSTNAME},${START_FILTER_COHORT_SNV_PASS_REPEATMASK},${END_FILTER_COHORT_SNV_PASS_REPEATMASK} \
