...
START_APPLY_RECALIBRATION_INDEL=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" --analysis_type ApplyRecalibration"
			...
			CMD=${CMD}" --input:VCF ${CORE_PATH}/${OUTPUT_DIR}/TEMP/CONTROLS_PLUS_${FAMILY}.VQSR.SNP.vcf"
		...
		CMD=${CMD}" --out ${CORE_PATH}/${OUTPUT_DIR}/TEMP/CONTROLS_PLUS_${FAMILY}.VQSR.SNP_INDEL.vcf"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${OUTPUT_DIR},J01,APPLY_RECALIBRATION_INDEL,${HOSTNAME},${START_APPLY_RECALIBRATION_INDEL},${END_APPLY_RECALIBRATION_INDEL} \
