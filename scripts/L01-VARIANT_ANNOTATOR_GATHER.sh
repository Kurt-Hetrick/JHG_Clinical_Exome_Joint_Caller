...
START_VARIANT_ANNOTATOR_GATHER=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" --outputFile ${CORE_PATH}/${OUTPUT_DIR}/${FAMILY}/VCF/RAW/CONTROLS_PLUS_${FAMILY}.VQSR.ANNOTATED.vcf.gz"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${OUTPUT_DIR},L01,VARIANT_ANNOTATOR_GATHER,${HOSTNAME},${START_VARIANT_ANNOTATOR_GATHER},${END_VARIANT_ANNOTATOR_GATHER} \
