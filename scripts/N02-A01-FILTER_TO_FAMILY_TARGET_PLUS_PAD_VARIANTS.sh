...
START_FILTER_TO_FAMILY_TARGET_VARIANT_ONLY=`date '+%s'`
	...
	# construct command line
		...
		CMD=${CMD}" --analysis_type SelectVariants"
			...
			CMD=${CMD}" --variant ${CORE_PATH}/${OUTPUT_DIR}/TEMP/${FAMILY}.VQSR.ANNOTATED.ALL.SITES.TARGET.vcf.gz"
		CMD=${CMD}" --out ${CORE_PATH}/${OUTPUT_DIR}/$FAMILY/EMEDGENE/${FAMILY}.VARIANT_SITES_TARGET.vcf.gz"
...
# write out timing metrics to file
	...
	echo ${FAMILY}_${OUTPUT_DIR},O01,FILTER_TO_FAMILY_TARGET_VARIANT_ONLY,${HOSTNAME},${START_FILTER_TO_FAMILY_TARGET_VARIANT_ONLY},${END_FILTER_TO_FAMILY_TARGET_VARIANT_ONLY} \
